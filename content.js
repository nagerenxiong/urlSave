...
$(".mod-detail-gallery .tab-pane").append("<div style='width:100%;height:100%;position:absolute;left:0;top:0;text-align:center;padding-top:150px;'>\
...
if (url.indexOf("s.1688.com") > 0) {
	setTimeout(function() {
		window.scrollTo(0, document.body.scrollHeight);
		setTimeout(function() {
			window.scrollTo(0, document.body.scrollHeight);
			setTimeout(function() {
				$(".sm-offer-photo.sw-dpl-offer-photo").append("<div style='width:100%;height:20%;position:absolute;left:0;top:0;text-align:center;'>\
		<span class='save_url_btn'  style='background-color:black;display:inline-block;color:#fff;padding:5px 10px;cursor:pointer'>点击收藏网址</span><span class='class_btn' style='background-color:red;display:inline-block;color:#fff;padding:5px 10px;cursor:pointer'>输入文件名</span>\
				...
				$(".save_url_btn").click(function() {
					var currentUrl = $(this).parent().prev().prev().prev().attr('href');
